          ...
          <div className="flex flex-wrap gap-2">
            {items.map((skill, index) => (
              <div
                ...
                className="inline-flex items-center gap-1.5 px-2 py-1.5 rounded-lg bg-white/5 border border-white/10 hover:border-white/20 hover:bg-white/10 transition-all duration-200 group"
                title={skill.name}
              >
